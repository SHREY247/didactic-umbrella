/*
Minimize the losses: Job Sequencing
*/

//We need to do the activity with highest loss per day as early as possible so as to minimize the overall loss
//But we also need to a short activity as early as possible, considering all jobs have same penalty
//Greed : (Loss/Days to complete)
#include <iostream>
#include <algorithm>
#include <vector>
using namespace std;
